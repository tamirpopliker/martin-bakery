...
import {
  ...
  Store, Settings, LogOut, TrendingUp, TrendingDown, Bell,
...
const PANEL_MANAGE = [
  ...
  { label: 'התרעות',        subtitle: 'כללים · חריגים · לוג',    Icon: Bell,         color: '#f59e0b', page: 'alerts' },
...
export default function Home() {
  ...
  function renderPage(): JSX.Element | null {
    ...
    if (page === 'alerts')               return <AlertsManagement onBack={() => setPage(null)} />
